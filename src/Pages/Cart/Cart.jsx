...
export default function Cart() {
  ...
  const [orderIdConfirmed, setOrderIdConfirmed] = useState(null);
            ...
            <>
              ...
              >
                ...
                <div>
                  ...
                  <button
                    onClick={() => {
                      setOrderIdConfirmed(item.id);
                    }}
                    className="bg-green-600 text-white px-5 py-2 rounded-md font-semibold cursor-pointer"
                  >
                    Confirm Order
                  </button>
                   {orderIdConfirmed === item.id && (
                <div className="absolute left-[5%] top[20%] z-50 w-full">
                  <Confirmation />
                </div>
              )}
                </div>
